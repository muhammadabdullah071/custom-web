...
<head>
    ...
    <title>Contact - Session Visit Counter</title>
                            ...
                            <div class="col-md-4">
                                <div class="card border-success">
                                    <div class="card-body text-center">
                                        ...
                                        <span class="display-6 fw-bold text-success"><?= $_SESSION['contact_visits'] ?></span>
                                        <p class="text-muted small mt-1">visits</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card border-warning">
                                    <div class="card-body text-center">
                                        ...
                                        <span class="display-6 fw-bold text-warning"><?= $_SESSION['services_visits'] ?? 0 ?></span>
                                        <p class="text-muted small mt-1">visits</p>
                                    </div>
                                </div>
                            </div>
